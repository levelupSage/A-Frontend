...
import { BidSettings } from "../bid-settings/bid-settings";
...
@Component({
  ...
  imports: [CommonModule, FormsModule, BidHistory, BidSettings, BidForm],
  templateUrl: './bid-management.html',
  styleUrl: './bid-management.css',
})

export class BidManagement implements OnInit {
prevPage() {
